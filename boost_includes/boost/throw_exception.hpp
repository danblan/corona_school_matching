...
inline BOOST_NORETURN void throw_exception( std::exception const & e ){throw 11;} // user defined
inline BOOST_NORETURN void throw_exception( std::exception const & e, boost::source_location const & loc ); // user defined
